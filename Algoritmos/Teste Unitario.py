...
# Verificar se a pasta XMLNovos contém novos arquivos
# Caso tenha, irá pegar o XML, abrir e inserir os novos dados no banco de dados
# finalizando o processo, enviará ou deletará o XML para a pasta XMLConsumidos
# deixando pronto para o programa pesquisar os dados necessários
def listarAnosXML():
    ...
    for s in itemList:
        ...
        while i != len(anoVer):
            ...
            ##ARRUMAR 
            if int(s.attributes['ANO-PRODUCAO'].value) != anoVer[i]:
    ...
    print("Quantidade de ano: ", qtdAno)
    print (anoVer)
